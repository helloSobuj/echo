...
export default async function Image() {
  ...
  const isLogoUriLocal = logoUri.includes('echo-logo') || logoUri.includes('lk-logo');
  const wordmarkUri =
    logoUri === APP_CONFIG_DEFAULTS.logoDark ? 'public/echo-logo-dark.svg' : logoUri;
